        ...
        <div class="container">
            ...
            <form action="/register" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <label class="input-group-btn">
                            <span style="color: white;" class="btn global-accent-bg">
                                Browse&hellip; <input required name="resume" type="file" style="display: none;">
                            </span>
                        </label>
                ...
                <div class="form-group generalReveal">
                    ...
                    <input class="form-control" type="text" placeholder="https://github.com/adalovelace" name="github_url" id="github_url" value="{{ old('github_url') }}">
                </div>

                <div class="form-group generalReveal">
                    <label for="linkedin_url">LinkedIn URL</label>
                    <input class="form-control" type="text" placeholder="https://www.linkedin.com/in/adalovelace" name="linkedin_url" id="linkedin_url" value="{{ old('linkedin_url') }}">
                </div>
